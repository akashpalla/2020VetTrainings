...
public class Robot extends TimedRobot {
  ...
  private double kP, kD, kI, sum, pastTime, currentTime, pastError;
  ...
  public double getCurrentDistance(){
    return frontLeft.getSelectedSensorPosition() /4096 /8.8 * Math.PI * 6;  
  }
  ...
  public void teleopPeriodic() {
    ...
    slope = (error - pastError)/ deltaTime;
    sum += error * (deltaTime);
    output = kP * error + kI * sum + kD * slope;
